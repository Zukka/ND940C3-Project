...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        custom_button.setOnClickListener {
            ...
            createChannel(getString(R.string.download_notification_channel_id), getString(R.string.notification_channel))
    ...
    private fun showToastMessge() {
        Toast.makeText(applicationContext,"Please select the file do download",Toast.LENGTH_SHORT).show()
    }
